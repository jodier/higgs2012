...
Analysis::AnalysisMuonEfficiencyScaleFactors::AnalysisMuonEfficiencyScaleFactors(void) {
...
Analysis::AnalysisMuonEfficiencyScaleFactors::AnalysisMuonEfficiencyScaleFactors(
...
void Analysis::AnalysisMuonEfficiencyScaleFactors::PrintValues() const
{
...
void Analysis::AnalysisMuonEfficiencyScaleFactors::init(
                                    const std::string & alg,
                                    const std::vector<double> int_lum,
                                    const std::string & unit,
                                    std::string dir) {
...
double Analysis::AnalysisMuonEfficiencyScaleFactors::scaleFactor(
...
double Analysis::AnalysisMuonEfficiencyScaleFactors::scaleFactorUncertainty(
                                            const TLorentzVector & tlv) const {
    int bin=get_pt_eta_phi_bin_index(tlv);
    if(bin<0) return 0.;
...
double Analysis::AnalysisMuonEfficiencyScaleFactors::scaleFactorSystematicUncertainty(
                                            const TLorentzVector & tlv) const {
...
void Analysis::AnalysisMuonEfficiencyScaleFactors::read_file(
...
int Analysis::AnalysisMuonEfficiencyScaleFactors::get_pt_eta_phi_bin_index(
                                            const TLorentzVector & tlv) const {

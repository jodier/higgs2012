...
class DiphotonVertexIDTool 
{
  public :
    DiphotonVertexIDTool(
      bool debug=false,
      TString="$ROOTCOREDIR/data/egammaAnalysisUtils/DiphotonVertex_MLP.weights.xml",
      TString="$ROOTCOREDIR/data/egammaAnalysisUtils/DiphotonVertex_MLP2.weights.xml",

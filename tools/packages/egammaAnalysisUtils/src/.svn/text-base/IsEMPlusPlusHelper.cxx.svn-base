...
// ====================================================================
bool isEMPlusPlusHelper::IsLoosePlusPlus0(const egamma* eg, egammaMenu::egMenu menu,
					 bool debug,
					 bool isTrigger){
...
// ====================================================================
bool isEMPlusPlusHelper::IsLoosePlusPlus1(const egamma* eg, egammaMenu::egMenu menu,
					 bool debug,
					 bool isTrigger){
...
// ====================================================================
bool isEMPlusPlusHelper::IsLoosePlusPlus(const egamma* eg, egammaMenu::egMenu menu, 
					 bool debug,
					 bool isTrigger){
...
// ====================================================================
bool isEMPlusPlusHelper::IsMediumPlusPlus(const egamma* eg, egammaMenu::egMenu menu, 
					  bool debug,
					  bool isTrigger){
    ...
    // fraction of energy reconstructed in the 1st and 3rd sampling
    double f1     = eg->detailValue(egammaParameters::f1);
...
// ====================================================================
bool isEMPlusPlusHelper::IsTightPlusPlus(const egamma* eg, egammaMenu::egMenu menu,  
					  bool debug,
					  bool isTrigger){

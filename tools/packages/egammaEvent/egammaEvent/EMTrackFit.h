...
class EMTrackFit : public egDetail
{
 public:
  ...
  Trk::MeasuredPerigee* getMeasuredPerigee() const;
...
private:
  ...
  bool fillPerigeeParamters(const Trk::MeasuredPerigee *trackParameters);
  /** @brief Fill the perigree error details */
  bool fillPerigeeErrors(const Trk::ErrorMatrix& errorMatrix);
  ...
  Trk::ErrorMatrix* getErrorMatrix() const; 

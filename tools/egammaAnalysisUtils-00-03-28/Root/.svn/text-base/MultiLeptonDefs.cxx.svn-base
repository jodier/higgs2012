...
bool passReta(double rEta, unsigned int eTBin, unsigned int etaBin){
  ...
  static const double cutReta37[11][10] = {{     0.581 ,  0.581 ,  0.526 ,  0.573 ,  0.537 ,  0.206 ,  0.627 ,  0.639 ,  0.690 ,  0.690 }    // 0 - 5 GeV
					    , {  0.748 ,  0.748 ,  0.705 ,  0.681 ,  0.647 ,  0.300 ,  0.689 ,  0.732 ,  0.775 ,  0.775 }    // 5 - 10 GeV
					    , {  0.827 ,  0.827 ,  0.804 ,  0.755 ,  0.702 ,  0.500 ,  0.759 ,  0.802 ,  0.830 ,  0.830 }    // 10 - 15 GeV
...
bool passEratio(double DEmaxs1, unsigned int eTBin, unsigned int etaBin){  
  ...
  static const double cutDEmaxs1[11][10] = { {    0.278 ,  0.278 ,  0.122 ,  0.054 ,  0.040 , -9999 ,  0.058 ,  0.136 ,  0.492 , -9999 }    // 0 - 5 GeV
					     , {  0.506 ,  0.506 ,  0.320 ,  0.099 ,  0.060 , -9999 ,  0.068 ,  0.196 ,  0.543 , -9999 }    // 5 - 10 GeV
					     , {  0.587 ,  0.587 ,  0.509 ,  0.215 ,  0.126 , -9999 ,  0.131 ,  0.281 ,  0.616 , -9999 }    // 10 - 15 GeV
...
bool passDeltaEta(double deltaEta, unsigned int eTBin, unsigned int etaBin){
  ...
  static const double cutDeltaEta[11][10]  = {{0.017,   0.017,   0.025,   0.030,   0.030,   0.030,   0.030,   0.030,   0.023,   0.030}, // 0
					      {0.012,   0.009,   0.009,   0.020,   0.025,   0.025,   0.022,   0.020,   0.011,   0.015}, // 5
					      {0.012,   0.009,   0.008,   0.010,   0.020,   0.020,   0.015,   0.010,   0.008,   0.013}, // 10
...
bool passDeltaPhiRes(double deltaPhiRes, bool isBrem, unsigned int eTBin, unsigned int etaBin){
  ...
  static const double maxDeltaPhiResHigh[11][10]  = {{0.085,   0.085,   0.073,   0.064,   0.052,   0.049,   0.052,   0.070,   0.046,   0.049}, // 0
						     {0.040,   0.040,   0.034,   0.037,   0.037,   0.034,   0.028,   0.031,   0.034,   0.037}, // 5
						     {0.022,   0.022,   0.022,   0.025,   0.025,   0.025,   0.022,   0.025,   0.028,   0.034}, // 10
  ...
  static const double minDeltaPhiResHigh[11][10]  = {{-0.133,  -0.133,  -0.139,  -0.139,  -0.136,  -0.148,  -0.139,  -0.088,  -0.064,  -0.046}, // 0
						     {-0.088,  -0.088,  -0.094,  -0.091,  -0.097,  -0.094,  -0.076,  -0.052,  -0.031,  -0.025}, // 5
  ...
  static const double minDeltaPhiResLow[11][10] = {{-0.100,  -0.100,  -0.103,  -0.121,  -0.124,  -0.124,  -0.109,  -0.073,  -0.049,  -0.037}, // 0
						   {-0.076,  -0.076,  -0.076,  -0.085,  -0.085,  -0.082,  -0.064,  -0.037,  -0.022,  -0.025}, // 5

                                           ...
                                           const double& Electron_Etcone20_Uncorrected) const
{
  ...
  double cutVal(-999.9);
  if( !m_rel16False_rel17True ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_etcone20DivEt_iso90 , EtBin , EtaBin );
  }
  if( m_rel16False_rel17True ){
    if( m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone20DivEt_iso90_rel17 , EtBin , EtaBin );
    }
    if( !m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone20DivEt_iso90_rel17_sumEt , EtaBin );
    }     
  }   
                                           ...
                                           const double& Electron_Etcone20_Uncorrected) const
{
  ...
  double cutVal(-999.9);
  if( !m_rel16False_rel17True ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_etcone20DivEt_iso95 , EtBin , EtaBin );
  }
  if( m_rel16False_rel17True ){
    if( m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone20DivEt_iso95_rel17 , EtBin , EtaBin );
    }
    if( !m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone20DivEt_iso95_rel17_sumEt , EtaBin );
    }       
  }   
                                           ...
                                           const double& Electron_Etcone20_Uncorrected) const
{
  ...
  double cutVal(-999.9);
  if( !m_rel16False_rel17True ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_etcone20DivEt_iso98 , EtBin , EtaBin );
  }
  if( m_rel16False_rel17True ){
    if( m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone20DivEt_iso98_rel17 , EtBin , EtaBin );
    }
    if( !m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone20DivEt_iso98_rel17_sumEt , EtaBin );
    }       
  }   
                                           ...
                                           const double& Electron_Etcone30_Uncorrected) const
{
  ...
  double cutVal(-999.9);
  if( !m_rel16False_rel17True ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_etcone30DivEt_iso90 , EtBin , EtaBin );
  }
  if( m_rel16False_rel17True ){
    if( m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone30DivEt_iso90_rel17 , EtBin , EtaBin );
    }
    if( !m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone30DivEt_iso90_rel17_sumEt , EtaBin );
    }       
  }   
                                           ...
                                           const double& Electron_Etcone30_Uncorrected) const
{
  ...
  double cutVal(-999.9);
  if( !m_rel16False_rel17True ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_etcone30DivEt_iso95 , EtBin , EtaBin );
  }
  if( m_rel16False_rel17True ){
    if( m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone30DivEt_iso95_rel17 , EtBin , EtaBin );
    }
    if( !m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone30DivEt_iso95_rel17_sumEt , EtaBin );
    }       
  }   
                                           ...
                                           const double& Electron_Etcone30_Uncorrected) const
{
  ...
  double cutVal(-999.9);
  if( !m_rel16False_rel17True ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_etcone30DivEt_iso98 , EtBin , EtaBin );
  }
  if( m_rel16False_rel17True ){
     if( m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone30DivEt_iso98_rel17 , EtBin , EtaBin );
    }
    if( !m_sumEtFalse_isEMTrue ){
      cutVal = m_GeV * this->CheckValidAndReturn( m_etcone30DivEt_iso98_rel17_sumEt , EtaBin );
    }      
  }  
                                           ...
                                           const double& Ptcone20) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone20DivEt_iso90 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone20DivEt_iso90_sumEt , EtaBin );
  }  
                                           ...
                                           const double& Ptcone20) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone20DivEt_iso97 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone20DivEt_iso97_sumEt , EtaBin );
  }  
  if( (Ptcone20 / Et) < cutVal ){
    fail0_pass1 = 1;
  }
                                           ...
                                           const double& Ptcone20) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone20DivEt_iso98 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone20DivEt_iso98_sumEt , EtaBin );
  }  
  if( (Ptcone20 / Et) < cutVal ){
    fail0_pass1 = 1;
  }
                                           ...
                                           const double& Ptcone20) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone20DivEt_iso99 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone20DivEt_iso99_sumEt , EtaBin );
  }  
  if( (Ptcone20 / Et) < cutVal ){
    fail0_pass1 = 1;
  }
                                           ...
                                           const double& Ptcone30) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone30DivEt_iso90 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone30DivEt_iso90_sumEt , EtaBin );
  }  
                                           ...
                                           const double& Ptcone30) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone30DivEt_iso97 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone30DivEt_iso97_sumEt , EtaBin );
  }  
  if( (Ptcone30 / Et) < cutVal ){
    fail0_pass1 = 1;
  }
                                           ...
                                           const double& Ptcone30) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone30DivEt_iso98 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone30DivEt_iso98_sumEt , EtaBin );
  }  
  if( (Ptcone30 / Et) < cutVal ){
    fail0_pass1 = 1;
  }
                                           ...
                                           const double& Ptcone30) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone30DivEt_iso99 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone30DivEt_iso99_sumEt , EtaBin );
  }  
  if( (Ptcone30 / Et) < cutVal ){
    fail0_pass1 = 1;
  }
                                           ...
                                           const double& Ptcone40) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone40DivEt_iso90 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone40DivEt_iso90_sumEt , EtaBin );
  }  
                                           ...
                                           const double& Ptcone40) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone40DivEt_iso97 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone40DivEt_iso97_sumEt , EtaBin );
  }  
  if( (Ptcone40 / Et) < cutVal ){
    fail0_pass1 = 1;
  }
                                           ...
                                           const double& Ptcone40) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone40DivEt_iso98 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone40DivEt_iso98_sumEt , EtaBin );
  }  
  if( (Ptcone40 / Et) < cutVal ){
    fail0_pass1 = 1;
  }
                                           ...
                                           const double& Ptcone40) const
{
  ...
  double cutVal(-999.9);
  if( m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone40DivEt_iso99 , EtBin , EtaBin );
  }
  if( !m_sumEtFalse_isEMTrue ){
    cutVal = m_GeV * this->CheckValidAndReturn( m_ptcone40DivEt_iso99_sumEt , EtaBin );
  }  
  if( (Ptcone40 / Et) < cutVal ){
    fail0_pass1 = 1;
  }

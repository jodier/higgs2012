...
public:
  ...
  // Forward electron Identification eta for probes >20 GeV
/*   std::vector<float> efficienciesRel172ICHEPForwardLoose; */
/*   std::vector<float> uncertaintiesRel172ICHEPForwardLoose; */
/*   std::vector<float> efficienciesRel172ICHEPForwardTight; */
/*   std::vector<float> uncertaintiesRel172ICHEPForwardTight; */
  ...
  // Forward electron Identification eta for probes >20 GeV
/*   std::vector<float> efficienciesRel172ICHEP_AFIIForwardLoose; */
/*   std::vector<float> uncertaintiesRel172ICHEP_AFIIForwardLoose; */
/*   std::vector<float> efficienciesRel172ICHEP_AFIIForwardTight; */
/*   std::vector<float> uncertaintiesRel172ICHEP_AFIIForwardTight; */
